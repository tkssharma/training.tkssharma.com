	...
	(function () {
		...
		angular
			...
			.controller("parentCntl", [
				...
				'$state',
				'FirebaseService',
				function parentCntl($scope, $rootScope, resourceData, $http,$state,FirebaseService) {
	    	...
	    	$state.go('app.login');
					...
					$scope.createTraining = function (form) {
						...
						$http
							.post('/api/createTraining', $scope.training)
					...
					$scope.createVideoForTraining = function (form, trainingid) {
						...
						$http
							.post('/api/createYouTubeVideo/' + trainingid, $scope.video)
							.success(function (response) {
								console.log("SUCCESS");
					...
					$scope.submitDiscussion = function (form) {
						...
						$http
							.post('/api/createDiscussion', $scope.training)
							.success(function (response) {
					...
					$scope.submitDiscussionVideo = function (form, id) {
						...
						$http
							.post('/api/createvideoDiscussion/' + id, $scope.video)
							.success(function (response) {
