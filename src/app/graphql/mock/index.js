const Mock = {
  data: [
    ...
    {
      kind: 'youtube#playlist',
      etag: 'Rx77dh6nTq3Z5VE5D7KrmikuA_A',
      id: 'PLdaoMeuMap9NJtEUmA0ckkpJHtSMP0bAI',
      snippet: {
        publishedAt: '2023-10-24T07:59:48Z',
        channelId: 'UCdG7UiL4tQ3a0lmeb_a-0cQ',
        title: 'Web developer setup and Toolings',
        description: 'Web developer setup and Toolings',
        thumbnails: {
          default: {
            url: 'https://i.ytimg.com/vi/ixJw0CPw-yw/default.jpg',
            width: 120,
            height: 90,
          },
          medium: {
            url: 'https://i.ytimg.com/vi/ixJw0CPw-yw/mqdefault.jpg',
            width: 320,
            height: 180,
          },
          high: {
            url: 'https://i.ytimg.com/vi/ixJw0CPw-yw/hqdefault.jpg',
            width: 480,
            height: 360,
          },
          standard: {
            url: 'https://i.ytimg.com/vi/ixJw0CPw-yw/sddefault.jpg',
            width: 640,
            height: 480,
          },
        },
        channelTitle: 'lifewithcode',
        localized: {
          title: 'Web developer setup and Toolings',
          description: 'Web developer setup and Toolings',
        },
    ...
    {
      kind: 'youtube#playlist',
      etag: 'yzljTNORI1KqFT7DUxfwaenulik',
      id: 'PLdaoMeuMap9NlN7fcrigJNA5eKAo-Kz0a',
      snippet: {
        ...
        thumbnails: {
          ...
          standard: {
            url: 'https://i.ytimg.com/vi/IdDAvI-a024/sddefault.jpg',
            width: 640,
            height: 480,
          },
          maxres: {
            url: 'https://i.ytimg.com/vi/IdDAvI-a024/maxresdefault.jpg',
            width: 1280,
            height: 720,
          },
        },
    ...
    {
      kind: 'youtube#playlist',
      etag: 'gH-L2FaMp8opjxDSjmd1-fclmE0',
      id: 'PLdaoMeuMap9Ny0XjyaBVflqVsvKOjwzrC',
      snippet: {
        ...
        thumbnails: {
          ...
          standard: {
            url: 'https://i.ytimg.com/vi/pfGsfuL09u4/sddefault.jpg',
            width: 640,
            height: 480,
          },
          maxres: {
            url: 'https://i.ytimg.com/vi/pfGsfuL09u4/maxresdefault.jpg',
            width: 1280,
            height: 720,
          },
        },
    ...
    {
      kind: 'youtube#playlist',
      etag: 'L3UI7X6vbuwSgNJjI9LJhUA5qo4',
    ...
    },
    {
      ...
      snippet: {
        ...
        description:
          'Welcome to this NestJS tutorial for absolute beginners. In the following, you’ll learn NestJS from the ground up which means that we’ll go through all steps necessary to get NestJS installed, create a new NestJS project from scratch and implement a first example from start to finish.\n\nIts master course covering everything on nestjs',
        thumbnails: {
          default: {
    ...
    {
      kind: 'youtube#playlist',
      etag: 'f6JOTZxYPi8OStjWak-gfjHRS1o',
      ...
      snippet: {
        ...
        thumbnails: {
          default: {
            url: 'https://i.ytimg.com/vi/3Q_g_PB-j2A/default.jpg',
            width: 120,
            height: 90,
          },
          medium: {
            url: 'https://i.ytimg.com/vi/3Q_g_PB-j2A/mqdefault.jpg',
            width: 320,
            height: 180,
          },
          high: {
            url: 'https://i.ytimg.com/vi/3Q_g_PB-j2A/hqdefault.jpg',
            width: 480,
            height: 360,
          },
          standard: {
            url: 'https://i.ytimg.com/vi/3Q_g_PB-j2A/sddefault.jpg',
            width: 640,
            height: 480,
          },
          maxres: {
            url: 'https://i.ytimg.com/vi/3Q_g_PB-j2A/maxresdefault.jpg',
            width: 1280,
            height: 720,
          },
        },
    ...
    {
      kind: 'youtube#playlist',
      etag: 'THEN4oKeBP8JwQHCO5ZbXL4VfkM',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'ZJu2dQgS4rdlBwNOziv-zYhvkqA',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'yseEPrONzQSNe7YzfQu1P_EgCh0',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'JsZGDZR5yFsDza6R3oG-lY5C4fA',
    ...
    {
      kind: 'youtube#playlist',
      etag: '5v2Ru9tyNTqZxWBvEW-rwxJ2riA',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'qWkt_JQ01ZulAMw4NV7TTOEPV4Y',
    ...
    {
      kind: 'youtube#playlist',
      etag: '17YNhUXa-piXNq8B3oahoM5Lafs',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'wuLTrlQiNh0erBYQ2mNcpGTIriU',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'KBe_a8rblCOV4RL3JcIy0pMZK_I',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'iAZ_4wXaCYS0FwG4DbQY1Fa8zo0',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'QPgfKl0z9uwvx6MGQ5jQ9yK6F5I',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'Z1H4ve_YbY7-biXaLVGksENhbdI',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'NpdzZHtm0JpNwEQp0glZZbFvppg',
    ...
    {
      kind: 'youtube#playlist',
      etag: 'KFRZuEwNShhxX4sXiyCSHvgv7MU',
